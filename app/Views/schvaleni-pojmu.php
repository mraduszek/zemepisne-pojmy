...
foreach ($seznam as $row) {
    $box = '<input type="checkbox" name="box[]" value="' . $row->idpojmy . '">';
    $radek = array($box, $row->nazev, $row->nazevKat);
    $table->addRow($radek);
}
...
<div class="container">
    <div class="row">
        <div class="col-12 m-2">
            <form id="approvalForm" action="<?= base_url('admin/schvalitSmazat') ?>" method="post">
                <?=$table->generate();?>
