...
<div class="container">
    <div class="row">
        <div class="col-12 m-2">
            <form id="form" action="<?= base_url('admin/schvalitVymazat2') ?>" method="post">
                <?=$table->generate();?>
                <input type="hidden" name="action" id="action" value="">
                <button class="btn btn-success" type="button" onclick="setActionAndSubmit('schvalit')">Schválit</button>
                <button class="btn btn-danger" type="button" onclick="setActionAndSubmit('vymazat')">Smazat</button>
            </form>
        </div>
    </div>
</div>
